...
class SCLTrainer(Trainer):
    ...
    def __init__(self, config, model):
        super(SCLTrainer, self).__init__(config, model)
    ...
    def fit(self, train_data, valid_data=None, verbose=True, saved=True, show_progress=False, callback_fn=None):
        ...
        # Initialize semantic feature clusters
        self.model.semantic_step()
    ...
    def evaluate(self, eval_data, load_best_model=True, model_file=None, show_progress=False):
        ...
        self.struct = self.eval_collector.get_data_struct()
        
        result = self.evaluator.evaluate(self.struct)
